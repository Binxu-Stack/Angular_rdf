...
void ComputeAngularRDF::compute_array()
{
  ...
  if (domain->dimension == 3) {
	...
	//if (gr > 0.0) {
	//  array[ibin][3+3*m] = ((ibin == 0) ? -rho*(gr * log(gr) - (gr - 1)) * array[ibin][0]*array[ibin][0] * delr :  array[ibin-1][3+3*m] -
	//   rho*(gr * log(gr) - (gr - 1)) * array[ibin][0]*array[ibin][0] * delr );
	//}else{
	//  array[ibin][3+3*m] = ((ibin == 0) ? -rho*array[ibin][0]*array[ibin][0]*delr : array[ibin-1][3+3*m] -
