...
ComputeStyle(angular_rdf,ComputeAngularRDF)

#else

#ifndef LMP_COMPUTE_ANGULARRDF_H
#define LMP_COMPUTE_ANGULARRDF_H
...
class ComputeAngularRDF : public Compute {
 public:
  ComputeAngularRDF(class LAMMPS *, int, char **);
  ~ComputeAngularRDF();
  void init();
 ...
 private:
  double angle_lo, angle_hi; // angle region for angular rdf
